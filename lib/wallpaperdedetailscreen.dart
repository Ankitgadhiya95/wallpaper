...
class WallpaperDetailScreen extends StatefulWidget {
  const WallpaperDetailScreen({super.key, required this.wall});
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              ...
              icon: const Icon(Icons.download_sharp, color: Color(0Xffe0d7d7ff))),
          IconButton(
              onPressed: () {
              ...
              }, icon: const Icon(Icons.image, color: Color(0Xffe0d7d7ff))),
        ],
        backgroundColor: const Color.fromRGBO(40, 57, 94, 0),
        title: const Text(
          "",
